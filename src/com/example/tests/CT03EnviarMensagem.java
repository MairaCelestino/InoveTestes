...
public class CT03EnviarMensagem {
	...
	private final String pathChromeDriver = "C:\\Selenium\\chromedriver.exe"; // PARA RECONHECER O DRIVE DO FIREFOX
	...
	public void testCT03EnviarMensagem() throws Exception {
		...
		driver.findElement(By.name("your-message")).sendKeys("Quais mÛdulos tem o curso?");
