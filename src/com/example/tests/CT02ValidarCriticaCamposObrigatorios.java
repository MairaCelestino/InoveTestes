...
public class CT02ValidarCriticaCamposObrigatorios {
	...
	private final String pathFirefoxDriver = "C:\\Selenium\\geckodriver.exe"; // PARA RECONHECER O DRIVE DO FIREFOX

	@BeforeClass(alwaysRun = true)
	public void setUp() throws Exception {
		System.setProperty("webdriver.gecko.driver", pathFirefoxDriver);
		driver = new FirefoxDriver();
		driver.manage().window().maximize(); //	BROWSER É EXIBIDO EM TELA CHEIA
	...
	public void testCT02ValidarCriticaCamposObrigatorios() throws Exception {
		// Acessa a pÃ¡gina de contato do site Inove Teste
		driver.get(baseUrl + "/contato");
		// Clica no botÃ£o Enviar sem preencher nos campos
		driver.findElement(By.cssSelector("input.wpcf7-form-control.wpcf7-submit")).click();
		// Valida as criticas dos campos obrigatorios
